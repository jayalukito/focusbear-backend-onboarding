...
- _Note: [Add any specific logic errors or warnings your linter flagged here, such as missing return statements or unused imports]_
...
Writing good comments is an art. The overarching rule is that code should explain _what_ it is doing and _how_ it is doing it, while comments should explain _why_.
...
# Writing Unit Tests for Clean Code #72

## Reflections

### How do unit tests help keep the code clean ?

Unit testing acts as a powerful architectural design tool that naturally forces your code to be cleaner. When you write tests, you quickly discover that monolithic or tightly coupled code is incredibly difficult to set up and test. This friction naturally encourages you to break large functions into smaller, single-responsibility modules and decouple your core logic from external dependencies like databases or APIs. Furthermore, a comprehensive test suite acts as a safety net, empowering you to fearlessly refactor and clean up messy code with the absolute confidence that you haven't broken the underlying functionality.

### What issues did you find while testing ?

Not much the unit test behaves as expected. My main issue is understanding how to do the folder structuring of folder testing. Where in this case I did my research and found several methods to structure unit testings: Centralized Directory, Colocation.
